...
@NamedQuery(name="Resa.findResaByClient", 
query="SELECT r FROM Reservation r WHERE r.client.id = :idClient")
public class Reservation {
	...
	@JoinTable(name = "Resa_Personne", joinColumns = { @JoinColumn(name = "idResa") }, inverseJoinColumns = {
	...
	public Reservation(Long idResa, String comment, Date dateResa, Client client) {
		super();
		this.idResa = idResa;
